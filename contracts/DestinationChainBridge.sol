...
contract DestinationChainBridge is Ownable {
    ...
    constructor(address _tokenAddress, address _oracleAddress, uint256 _feePercentage) {
        allowedBridgeTokens[_tokenAddress] = true;
        oracleAddress = _oracleAddress;
        feePercentage = _feePercentage;
    }

    function bridgeTokens(address _tokenAddress, uint256 _amount, uint256 _chainId) public {
